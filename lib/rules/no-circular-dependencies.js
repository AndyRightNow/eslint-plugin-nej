...
var ruleDebugPrefix = 'plugin-rules:' + ruleId;
var fs = require('fs');
var ruleDebug = require('debug')(ruleDebugPrefix);
var tdDebug = require('debug')(ruleDebugPrefix + ':traceDependencies');
var rdgDebug = require('debug')(ruleDebugPrefix + ':resolveDependencyGraph');
var ccDebug = require('debug')(ruleId + ':checkCircular');
if (process.env.NODE_ENV === 'test') {
    var mkdirp = require('mkdirp');
}
var traverser = new(require('eslint/lib/util/traverser'))();
var map = utils.map;
var find = utils.find;
